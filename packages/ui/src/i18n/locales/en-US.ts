...
const enUS: Record<string, string> = {
  ...
  "occupationOnboarding.modeDescription": "How would you like CodeZ to show its work?",
  ...
  "occupationOnboarding.memoryDescription": "Let CodeZ remember your preferences and work context.",
  ...
  "startup.global.silent": "Starting CodeZ",
  ...
  "startup.global.servicesFailed":
    "Local data is ready, but app services failed to start. Copy the diagnostics, then exit and reopen CodeZ.",
  ...
  "startup.global.starting_services": "Starting CodeZ",
  "startup.global.ready": "Local data is ready",
  "startup.global.failed": "Startup preparation failed",
  "startup.global.help":
    "CodeZ will open when preparation finishes. Large histories may take longer. Please keep the app running.",
  ...
  "startup.global.error.lock_timeout":
    "Waiting for the database write lock timed out. Another CodeZ or CLI process may be updating data. Retry after it finishes.",
  ...
  "startup.global.error.startup_status_timeout":
    "No startup status was received. Exit and reopen CodeZ. If it fails again, provide the diagnostics to support.",
  "startup.global.error.transport_closed":
    "The preparation process exited or disconnected. Exit and reopen CodeZ to check the migration records again.",
  "startup.global.error.unsupported_runtime":
    "The configured Agent does not support storage preparation. Restore the bundled Agent, then reopen CodeZ.",
  ...
  "settings.computerUse.disabledToast":
    "Computer Use is disabled. Existing conversations require a CodeZ restart to take effect.",
  ...
  "conversationShare.permission.linkEditorHint": "Import into CodeZ",
  ...
  "conversationShare.import.loginRequired":
    "This share cannot be imported anonymously. Sign in to CodeZ and try again",
  ...
  // Welcome / Login
  "welcome.title": "Welcome to CodeZ",
  "welcome.username": "Username",
  "welcome.password": "Password",
  "welcome.login": "Login",
  "welcome.loggingIn": "Logging in...",
  "welcome.loginFailed": "Login failed",
  "login.title": "Welcome to CodeZ",
  "login.description": "Connect your account to start using CodeZ",
  ...
  "logout.confirm.title": "Disconnect and restart CodeZ?",
  ...
  "modelTrajectory.empty": "No model calls recorded (only CodeZ Agent writes model-io)",
  ...
  "worktree.location": "Work location",
  "worktree.local": "Local",
  "worktree.worktree": "Worktree",
  "worktree.newLocal": "New local worktree",
  "worktree.unavailable": "Requires a local Git project",
  "worktree.searchBranch": "Search branches",
  "worktree.noBranch": "No local branches",
  "worktree.branchLoadFailed": "Could not load branches",
  ...
  "titleBar.menu.help.about": "About CodeZ",
  ...
  "forceUpdate.title": "Update CodeZ to continue",
  ...
  "workspaceSidebar.unavailableLocalDirectory":
    "The workspace directory does not exist or cannot be accessed. You can only view history for now. Restore the directory and restart CodeZ to continue.",
  ...
  "ssh.assetInstallModeDescription":
    "Remote server download reduces upload waiting, but the server must reach the CodeZ CDN and have download, extract, and checksum tools.",
  ...
  "chat.changeSummary.rewindDialog.description":
    "CodeZ checks current file content again before writing. If another process changed a file, no files will be written.",
  ...
  "settings.worktrees.absolutePathRequired": "Enter an absolute path.",
  "settings.worktrees.removeBeforeMove":
    "Remove worktrees in the current directory before changing it.",
  "settings.worktrees.save": "Save",
  "settings.worktrees.loading": "Loading…",
  "settings.worktrees.refresh": "Refresh",
  "settings.worktrees.empty": "No worktrees created by CodeZ yet.",
  "settings.worktrees.item": "Worktree",
  "settings.worktrees.clean": "Ready to remove",
  "settings.worktrees.dirty": "Uncommitted or ignored files; cannot remove",
  "settings.worktrees.locked": "Locked; cannot remove",
  "settings.worktrees.open": "Open in this window; close it before removing",
  "settings.worktrees.newChat": "New chat here",
  "settings.worktrees.remove": "Delete",
  "settings.worktrees.removeTitle": "Delete this worktree?",
  "settings.worktrees.removeDescription":
    "Make sure no chat is running here in another window. CodeZ cannot restore this directory after deletion.",
  ...
  "settings.terminalFontFamilyDescription":
    "Leave blank to auto-detect system terminal settings; set a value to override the CodeZ terminal font.",
  ...
  "settings.zcodeInteractionBehaviorDescription":
    "While CodeZ is running, add follow-up actions to the queue or guide them to run after the next tool call.",
  ...
  "settings.dataBaseDirForbiddenInstallDir":
    "The data directory cannot be the CodeZ installation folder on Windows. Choose a folder outside the app install location.",
  ...
  "settings.migration.sectionDescription":
    "Scan native Claude Code history on this machine, optionally filter by workspace and activity window, then import the selected sessions into their matching CodeZ task lists.",
  ...
  "resourceManager.storage.summaryTotal": "Total used by CodeZ",
  ...
  "resourceManager.storage.diskUsage": "CodeZ uses {used}",
  ...
  "settings.browser.desktopOnly": "Browser data can only be managed in the CodeZ desktop app.",
  ...
  "settings.browser.import.helperVerificationFailed":
    "CodeZ could not verify its Windows secure import component. Reinstall or update CodeZ before importing cookies.",
  ...
  "settings.browser.import.adminConfirmDescription":
    "Chrome protects cookies with App-Bound encryption on Windows. For this import only, CodeZ will request administrator access, start a temporary system service, and delete it immediately afterward. Chrome passwords are never read or imported.",
  ...
  "settings.mcp.description": "Manage MCP server configurations used by CodeZ Agent.",
  ...
  "settings.mcp.host.activeDescription":
    "CodeZ provides this MCP server for the {pluginName} plugin. Its runtime identity is managed by the host.",
  ...
  "settings.mcp.statusOnlyUnsupported":
    "This CodeZ Agent cannot refresh OAuth status. Upgrade or restart CodeZ, then reopen MCP settings to run a full refresh.",
  ...
  "settings.mcp.failure.not_authenticated":
    "You are not signed in. Sign in to CodeZ to use this MCP server.",
  ...
  "settings.mcpServers.import.importing": "Importing MCP servers into CodeZ",
  ...
  "settings.modelProvider.startPlan.highlight.trial.description":
    "Timing starts after signing in to CodeZ 3.x.",
  ...
  "settings.modelProvider.startPlan.compatibility":
    "Supports BYOK and BYOA. Base URL, API format, and API Key are maintained by CodeZ automatically.",
  ...
  "settings.modelProvider.codingPlan.purchase.teamMemberNoticeDescription":
    "Add yourself or other members on the BigModel team plan management page. Once assigned, the team quota will be available in CodeZ.",
  ...
  "settings.modelProvider.help.contextWindow":
    "The context capacity the model can process at once, in tokens. CodeZ uses this to manage context.\nDo not exceed the model's actual limit.",
  ...
  "settings.usage.billingBanner.description":
    "Connect your {provider} account to query Coding Plan entitlement, then keep coding in CodeZ after purchase or setup.",
  ...
  "settings.usage.entitlementServerMcpUsage": "CodeZ MCP",
  ...
  "sidebar.usage.plan.mcp": "CodeZ MCP",
  "sidebar.usage.plan.zcodeMcp": "CodeZ MCP",
  "sidebar.usage.plan.zcodeMcpDescription": "Daily aggregate quota for CodeZ built-in plugin MCPs",
  ...
  "settings.skills.import.mode.copy.description":
    "Copy the full skill directory into CodeZ. Later changes in the external agent directory will not sync automatically.",
  "settings.skills.import.mode.symlink.description":
    "Create a directory link to the external agent skill. CodeZ follows later source changes, but the skill depends on that source path remaining available.",
  "settings.skills.import.importing": "Importing skills into CodeZ",
  ...
  "settings.subagents.description":
    "Manage user-level subagent Markdown files consumed by CodeZ Agent.",
  ...
  "settings.plugins.store.subtitle":
    "Extend CodeZ with skills, commands, and MCP servers from plugins",
  ...
  "settings.plugins.import.mode.copy.description":
    "Copy the full plugin directory into CodeZ and register it in plugins.dirs. Later changes in the external agent directory will not sync automatically.",
  "settings.plugins.import.mode.symlink.description":
    "Create a directory link to the external agent plugin and register it in plugins.dirs. CodeZ follows later source changes, but the plugin depends on that source path remaining available.",
  "settings.plugins.import.importing": "Importing plugins into CodeZ",
  ...
  "settings.commands.description":
    "Manage CodeZ Agent .md command files. Commands can be invoked with /command-name in chat.",
  "settings.commands.sourceFilterLabel": "Source filter",
  "settings.commands.source.zcodeAgent": "CodeZ Agent",
  ...
  "settings.commands.import.mode.copy.description":
    "Copy the command file into CodeZ. Later changes in the external agent file will not sync automatically.",
  "settings.commands.import.mode.symlink.description":
    "Create a file link to the external agent command. CodeZ follows later source changes, but the command depends on that source path remaining available.",
  "settings.commands.import.importing": "Importing commands into CodeZ",
  ...
  "settingsSync.action.finish": "Start using CodeZ",
  "settingsSync.agent.zcode": "CodeZ Agent",
  ...
  "settingsSync.discovery.helper":
    "Only missing items will be imported and your current CodeZ settings will not be overwritten.",
  ...
  "onboarding.dialog.title": "Welcome to CodeZ",
  ...
  "onboarding.welcome.title": "Welcome to CodeZ",
  "onboarding.welcome.start": "Start CodeZ",
  ...
  "onboarding.stepDescription.migration":
    "Start migration and wait while CodeZ imports your selections.",
  ...
  "onboarding.agentsFile.confirmDescription":
    "CodeZ will copy {source} to {target}.\nIf the target file already exists, the CodeZ default AGENTS configuration will be overwritten.",
  ...
  "chat.placeholder.newTask":
    "Ask CodeZ anything, @ to add context, / for commands or capabilities",
  "chat.placeholder.newTaskMobile": "Ask CodeZ anything…",
  ...
  "chat.modelSwitch.contextWindowGuard.description":
    "This conversation has used {used} tokens, which exceeds {modelName}'s available context of {target} tokens after reserving maximum output.\nCompress the current conversation with the current model first. If the compressed context fits, CodeZ will continue switching models.",
  ...
  "chat.toolbar.computerUse.tooltip.ready":
    "Computer Use ready — just describe what you want CodeZ to do",
  ...
  "chat.toolbar.computerUse.tooltip.error":
    "Computer Use enablement failed. Please restart CodeZ app and retry, or ask CodeZ to investigate the logs",
  ...
  "workflows.hub.empty.hint":
    "Design a workflow with CodeZ in chat, then have it save the workflow to a project once it works. Projects that aren't open don't appear here.",
  ...
  "workflows.hub.detail.whenToUse.help":
    "A routing hint for CodeZ: when this workflow is the right pick.",
  ...
  "workflows.hub.detail.script.note":
    "The script is read-only. To change it, revise it with CodeZ in chat and save a new version.",
  ...
  "chat.slash.emptyUnavailable":
    "No slash commands have been broadcast for the current CodeZ Agent session",
  ...
  "chat.quota.mcp.quotaExhausted":
    'CodeZ MCP "{server}" has used up today\'s quota. It resets tomorrow.',
  "chat.quota.mcp.codingPlanRequired":
    'No CodeZ MCP "{server}" quota. Sign in or get a Coding Plan to use it.',
  ...
  "resourceManager.appUsage": "CodeZ",
  ...
  "feedback.submit.template.section.copyErrorHeading": "CodeZ Error Info",
  ...
  "offPeak.keepAwakeBanner": "Keep your computer awake while CodeZ is running a chat.",
  ...
  "offPeak.form.instructionsPlaceholder":
    "Describe a task CodeZ can work on in the background, including the expected result and any constraints…",
  ...
  "chat.cuaReadiness.toolsNotLoaded":
    "CodeZ Computer Use is still preparing — its tools aren't loaded yet ({count} loaded). Grant the permissions below; tools appear once the helper is ready.",
  "chat.cuaReadiness.toolsPreparing":
    "CodeZ Computer Use is still preparing — its tools aren't loaded yet. Grant the permissions below; tools appear once the helper is ready.",
  ...
  "cuaPermission.modal.relaunchAppButton": "Restart CodeZ",
  "cuaPermission.modal.relaunchAppHint":
    "Still not working after restarting Helper? Restart CodeZ to fully reload the Helper process.",
  ...
  "cuaPermission.tools.untrustedRuntime":
    "Computer Use tools were found, but they did not come from the verified CodeZ plugin. Review the plugin installation, then check again.",
  ...
  "cuaPermission.ready.sessionValidationHint":
    "CodeZ will verify the Computer Use tools against the exact session when your first session starts.",
